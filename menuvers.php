            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse justify-content-between" id="navbarSupportedContent">
                    <ul class="navbar-nav ml-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item ">
                            <a class="nav-link" href="versement.php" id="navbarDropdown" >
                NOUVEAU VERSEMENT</a>
                            
                        </li>
                        <li class="nav-item ">
                            <a class="nav-link" href="listecompte.php" id="navbarDropdown" >
                LISTE COMPTE</a>
                            
                        </li>
                        <li class="nav-item dropdown">
                            <a class="nav-link" href="recherchevers10.php" id="navbarDropdown" >
                RECHERCHE</a>
