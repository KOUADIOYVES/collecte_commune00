            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse justify-content-between" id="navbarSupportedContent">
                    <ul class="navbar-nav ml-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item ">
                            <a class="nav-link" href="commercantok.php" id="navbarDropdown" >
                NOUVEAU COMMERCANT</a>
                            
                        </li>
                        <li class="nav-item ">
                            <a class="nav-link" href="listecom.php" id="navbarDropdown" >
                LISTE COMMERCANT</a>
                            
                        </li>
                        <li class="nav-item dropdown">
                            <a class="nav-link" href="recherchecom.php" id="navbarDropdown" >
                RECHERCHE</a>
