        ...
        <form method="GET">   
            <div class="row">
                <div class="col-sm-6 col-lg-3">
                    <input type="search" id="cherc" name="cherche" class="form-control" placeholder="Entrer le nom d'un commercant" >  
                </div>
                <div class="col-sm-6 col-lg-3">
                ...
                <div class="col-sm-6 col-lg-3"><button class="btn btn-outline-secondary" id="tout" name="listecom" type="submit">Liste des commercants</button></div>
            </div>
        </form>   
    </div>
        ...
        <tbody>
            <tr>
                ...
                <td><br><button type="submit" name="mod" id="mod"><a href="modifcom.php?codecom=<?=$row['codecom']; ?>">MOD</a></button>
                    <button type="submit" name="sup" id="sup"><a href="supcom.php?codecom=<?=$row['codecom']; ?>">SUP</a></button></td>
...
// initialisation des variables
    if(isset($_GET['valider'])){
        ...
        if(!empty($_GET['cherche'])){
            $sql = "SELECT  codecom, numcompte, nomcom, numcom, sexecom, photocom, zonecom, secactcom, restapay
            ...
            <div class="container-fluid" id="cont">
                ...
                <tbody>
                    ...
                    <td><br><br><?php echo $row['sexecom']; ?></td>
                    <td><br><br><?php echo $row['zonecom']; ?></td>
                    <td><br><br><?php echo $row['secactcom']; ?></td>
                    <td id="rest"><br><br><?php echo $row['restapay']; ?></td>
                    <td><br><br><button type="submit" name="mod" id="mod"><a href="modifcom.php?codecom=<?=$row['codecom']; ?>">MOD</a></button>
                        <button type="submit" name="sup" id="sup"><a href="supcom.php?codecom=<?=$row['codecom']; ?>">SUP</a></button></td>
                    ...
                    <h3>AUCUN COMMERCANT CORRESPONDANT A <span><?php echo" ".$recherche;?></span></h3>
                <?php
            }
        }else{?>
            <div class="contenair-fluid"><h3>SAISISSEZ LE NOM D'UN COMMERCANT</h3></div>
        <?php
        }
...
<?php
    if(isset($_GET['filtre'])){
        ...
        case(!empty($secact) AND empty($zone)):
            ...
            if($i>0){?>
                ...
                <h3><?php echo $i." COMMERCANTS DANS SECTEUR D'ACTIVITE "?><span><?php echo $secact;?></span></h3>
            <?php
                afficher($resultat);
            }else{ ?>
                <h3><?php echo " AUCUN COMMERCANT DANS SECTEUR D'ACTIVITE "?><span><?php echo $secact;?></span></h3><?php    
            }
            break;
        ...
        case(empty($secact) AND !empty($zone)):
            ...
            $i=0;
                ...
                if($i>0){?>
                    ...
                    <h3><?php echo $i." COMMERCANTS DANS LA ZONE DE ";?><span><?php echo $zone;?></span></h3>
                <?php
                    afficher($resultat);
                }else{ ?>
                    <h3><?php echo " AUCUN COMMERCANT DANS LA ZONE DE ";?><span><?php echo $zone;?></span></h3><?php    
                }            break;
        ...
        case(!empty($secact) AND !empty($zone)):
            ...
            $resultat=$req->fetchAll();
                ...
                if($i>0){?>
                    ...
                    <h3><?php echo $i." COMMERCANTS DANS LA ZONE DE ";?><span><?php echo $zone;?></span><?php echo" ET DANS SECTEUR D'ACTIVITE "?><span><?php echo $secact;?></span></h3>
                <?php
                    afficher($resultat);
                }else{ ?>
                    <h3><?php echo " AUCUN COMMERCANT DANS LA ZONE DE ";?><span><?php echo $zone;?></span><?php echo " ET DANS SECTEUR D'ACTIVITE "?><span><?php echo $secact;?></span></h3><?php    
                }
